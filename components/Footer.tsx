...
export default function Footer() {
  ...
  return (
    // <--- PERUBAHAN: bg-gray-200 menjadi dark:bg-gray-800
    <footer className="w-full bg-gray-200 dark:bg-gray-800 mt-16 py-8">
      <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8 text-sm text-gray-600 dark:text-gray-300"> {/* <--- PERUBAHAN: text-gray-600 menjadi dark:text-gray-300 */}
        {/* Kolom 1: Informasi Aplikasi/Hak Cipta */}
        <div className="flex flex-col items-center md:items-start text-center md:text-left">
          {/* <--- PERUBAHAN: text-gray-800 menjadi dark:text-gray-100 */}
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left">
          ...
          <ul className="space-y-1">
            {/* <--- PERUBAHAN: hover:text-purple-600 menjadi dark:hover:text-purple-400 */}
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left">
          {/* <--- PERUBAHAN: text-gray-800 menjadi dark:text-gray-100 */}
          <h3 className="font-bold text-gray-800 dark:text-gray-100 text-lg mb-2">Didukung Oleh</h3>
          {/* <--- PERUBAHAN: text-gray-500 menjadi dark:text-gray-400 */}
          <ul className="text-xs text-gray-500 dark:text-gray-400 space-y-1 md:space-y-0.5">
            <li>
            ...
            <li>
              {/* <--- PERUBAHAN: text-gray-600 menjadi dark:text-gray-400 pada ikon */}
