      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="mt-4 text-lg text-gray-600 dark:text-gray-300">
            Kenali wajah di balik karya-karya inspiratif RuangRiung. Mereka adalah para admin dan kontributor yang rajin berbagi
            eksperimen, tips, dan semangat kolaborasi di berbagai kanal digital.
          </p>
        </div>
            ...
            >
              ...
              <div className="flex flex-col gap-6 p-6">
                <div className="flex items-start gap-4">
                  <div className="relative h-24 w-24 overflow-hidden rounded-2xl border-4 border-purple-100 bg-purple-50 shadow-inner dark:border-purple-900 dark:bg-purple-900/40">
                    <Image
                  ...
                  <div>
                    <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100">{creator.name}</h2>
                    <p className="text-sm font-medium text-purple-600 dark:text-purple-300">{creator.role}</p>
