...
export const article: Article = {
    slug: 'kolaborasi-kreatif-chatbot-dan-gambar',
    ...
    content: `
      ...
      <h3 class="text-xl font-bold mt-6 mb-2">1. Mengatasi Masalah "Kanvas Kosong"</h3>
      <p class="mb-4">
      ...
      <p class="mb-4">
        <strong>Contoh Dialog Awal:</strong><br>
        <em>Anda: "Hai, bantu aku brainstorming ide untuk gambar tentang hutan ajaib. Aku ingin sesuatu yang unik, bukan sekadar pohon dan peri."</em>
      </p>
      <h3 class="text-xl font-bold mt-6 mb-2">2. Proses Brainstorming: Biarkan AI Memberi Inspirasi</h3>
      <p class="mb-4">
      ...
      <p class="mb-4">
        <strong>Contoh Balasan Chatbot:</strong><br>
        <em>"Tentu! Bagaimana dengan beberapa ide ini: 1. Hutan yang tumbuh di atas punggung kura-kura raksasa yang sedang tidur. 2. Hutan yang seluruhnya terbuat dari kristal bercahaya, dengan sungai dari merkuri cair. 3. Hutan terbalik, di mana akar-akar pohonnya mencakar langit."</em>
      </p>
      <h3 class="text-xl font-bold mt-6 mb-2">3. Mengembangkan Narasi Bersama</h3>
      <p class="mb-4">
      ...
      <p class="mb-4">
        <strong>Contoh Dialog Lanjutan:</strong><br>
        <em>Anda: "Aku suka ide hutan kristal. Mari kita kembangkan. Siapa yang tinggal di sana?"</em><br>
        <em>Chatbot: "Bagaimana jika ada makhluk pemalu mirip rubah dengan bulu yang berpendar? Mereka mungkin memanen cahaya dari kristal tersebut untuk bertahan hidup. Mereka bergerak tanpa suara di antara pepohonan kristal."</em>
      </p>
      <h3 class="text-xl font-bold mt-6 mb-2">4. Dari Percakapan Menjadi Prompt yang Kaya</h3>
      <p class="mb-4">
      ...
      <p class="mb-4">
        <strong>Prompt Final:</strong><br>
        <code>Seekor makhluk pemalu seperti rubah dengan bulu berpendar, sedang dengan hati-hati memanen cahaya dari pohon kristal raksasa yang bercahaya di sebuah hutan yang seluruhnya terbuat dari kristal. Suasananya magis dan sunyi, dengan sungai bintang cair mengalir di bawahnya. Gaya seni digital, pencahayaan sinematik, sangat detail.</code>
      </p>
      <p class="mt-6">
      ...
      <h3 class="text-xl font-bold mt-6 mb-2">5. Eksperimen dan Iterasi</h3>
      <p class="mb-4">
      ...
      </p>      <h3 class="text-xl font-bold mt-6 mb-2">6. Membangun Dunia yang Konsisten</h3>
      <p class="mb-4">
      ...
      <h3 class="text-xl font-bold mt-6 mb-2">7. Menggunakan Chatbot untuk Meningkatkan Kualitas Gambar</h3>
      <p class="mb-4">
      ...
      <h3 class="text-xl font-bold mt-6 mb-2">8. Memanfaatkan Fitur "Analisis Gambar" untuk Inspirasi Balik</h3>
      <p class="mb-4">
      ...
      <p class="mb-4">
        <strong>Contoh Penggunaan Fitur "Analisis Gambar":</strong><br>
