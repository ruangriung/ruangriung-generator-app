...
export const artStyles: ArtStyleCategory[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: "dollar-art", label: "Dollar Art Style" }
    ]
  },
  {
    ...
    options: [
      ...
      { value: "hair-collage", label: "Hair Collage" },
      { value: "collage-art", label: "Collage Art" }
    ]
  },
  {
    ...
    options: [
      ...
      { value: "caricature", label: "Caricature Art" },
      { value: "knitted-toy", label: "Knitted Toy Style" },
      { value: "movie-banner", label: "Movie Banner Style" },
      { value: "doll-figure", label: "Doll Figure Style" },
      { value: "green-army-toy", label: "Green Army Toy Style" },
      { value: "mannequin", label: "Mannequin Style" },
      { value: "miniature", label: "Miniature Style" },
      { value: "animatronic", label: "Animatronic Style" }
    ]
  },
  {
    ...
    options: [
      ...
      { value: "wayang-indonesia", label: "Wayang Indonesia Style" }
    ]
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { value: "relief-stones", label: "Relief Stones Style" },
      { value: "water-oil", label: "Water Oil Painting" }
    ]
  },
  {
    ...
    options: [
      ...
      { value: "calligram", label: "Calligram Art" }
    ]
  },
  {
    label: "3D & CGI",
  ...
  },
  {
    ...
    options: [
      ...
      { value: "gta", label: "GTA Style" },
      { value: "gacha-life", label: "Gacha Life Style" }
    ]
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { value: "muppet", label: "Muppet Style" },
      { value: "barbie", label: "Barbie Style" },
      { value: "south-park-cartoon", label: "South Park Cartoon Style" },
      { value: "pou", label: "Pou Style" },
      { value: "billy-mandy", label: "Billy and Mandy Style" },
      { value: "samurai-jack", label: "Samurai Jack Style" },
      { value: "chalk-zone-cartoon", label: "Chalk Zone Cartoon Style" }
    ]
  },
  {
    ...
    options: [
      ...
      { value: "nightmare-glitch", label: "Nightmare Glitch Art" },
      { value: "polkadot", label: "Polkadot Style" }
    ]
  },
  {
    ...
    options: [
      ...
      { value: "reflective-water-shadow", label: "Reflective Water Shadow" },
      { value: "glossy", label: "Glossy Effect" }
    ]
  },
  {
